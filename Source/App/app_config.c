...
ConfigDescription config_entry_options[] = {
    ...
    {PROGRESS_TOKEN, "Verbosity of the output, default is 1 [0: no progress is printed, 2: aomenc style output, 3: fancy progress]"},
    {NO_PROGRESS_TOKEN,
...
ConfigEntry config_entry[] = {
    ...
    {STARTUP_FG_LENGTH_TOKEN, "StartupFilmGrainLength", set_cfg_generic_token},
    {STARTUP_FG_INT_TOKEN, "StartupFilmGrainInt", set_cfg_generic_token},
